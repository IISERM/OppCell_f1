...
.config(function($routeProvider)
{
    $routeProvider.
      ...
      when('/progs', {controller:c_progs, templateUrl:'{=URL::to('database')=}/atemplates_progs'}).
      when('/scholarships', {controller:c_scholarships, templateUrl:'{=URL::to('database')=}/atemplates_scholarships'}).
      when('/jobs', {controller:c_jobs, templateUrl:'{=URL::to('database')=}/atemplates_jobs'}).
